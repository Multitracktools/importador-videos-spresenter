# Importador de Vídeos — protótipo 0.2.3
...
1. Instale `Importador-de-Videos-Spresenter-0.2.3.zip` em **Configurações → Plugins → Instalar**.
...
A versão 0.2.3 utiliza um aplicativo auxiliar em segundo plano no Windows ou macOS. Fundos recebem o MP4 diretamente. Para a categoria Vídeos, o plugin solicita apenas a normalização leve necessária para duração, áudio e controles, recusando uma recodificação pesada.
